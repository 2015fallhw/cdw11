...
bg2_40123232 = Blueprint('bg2_40123232', __name__, url_prefix='/bg2_40123232', template_folder='templates')




@bg2_40123232.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
