...
bg2_40123202 = Blueprint('bg2', __name__, url_prefix='/bg2_40123202', template_folder='templates')
...
@bg2_40123202.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg2_40123202.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg2_40123202.route('/circle36/<x>/<y>/<degree>')
