...
bg2_40123244 = Blueprint('bg2_40123244', __name__, url_prefix='/bg2_40123244', template_folder='templates')




@bg2_40123244.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
