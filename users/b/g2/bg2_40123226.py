...
bg2_40123226 = Blueprint('bg2_40123226', __name__, url_prefix='/bg2_40123226', template_folder='templates')




@bg2_40123226.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
