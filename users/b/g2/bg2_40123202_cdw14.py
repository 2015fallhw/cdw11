...
bg2_40123202_cdw14 = Blueprint('bg2_40123202_cdw14', __name__, url_prefix='/bg2_40123202_cdw14', template_folder='templates')

@bg2_40123202_cdw14.route('/threegear', defaults={'n1':15,'n2':20,'n3':18,'n4':10})
@bg2_40123202_cdw14.route('/threegear/<n1>/<n2>/<n3>/<n4>')
...
spur(cx+pr1+2*pr2+2*pr3+pr4, cy, m, n4, pa, 180-180/n4+(180-180/n2)*n2*n3/n4)
</script>
'''
