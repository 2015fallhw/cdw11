...
bg3_40123224 = Blueprint('bg3_40123224', __name__, url_prefix='/bg3_40123224', template_folder='templates')




@bg3_40123224.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
