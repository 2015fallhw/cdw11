...
bg3_40123242 = Blueprint('bg3_40123242', __name__, url_prefix='/bg3_40123242', template_folder='templates')




@bg3_40123242.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
