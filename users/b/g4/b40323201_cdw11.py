...
b40323201 = Blueprint('b40323201', __name__, url_prefix='/b40323201', template_folder='templates')
...
@b40323201.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@b40323201.route('/circle36/<x>/<degree>', defaults={'y': 0})
@b40323201.route('/circle36/<x>/<y>/<degree>')
#@bg4.route('/circle36/<int:x>/<int:y>/<int:degree>')
