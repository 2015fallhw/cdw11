...
bg11_40323245 = Blueprint('bg11_40323245', __name__, url_prefix='/bg11_40323245', template_folder='templates')
...
@bg11_40323245.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg11_40323245.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg11_40323245.route('/circle36/<x>/<y>/<degree>')

def drawcircle36(x, y, degree):
    return head_str + chain_str + circle36(int(x), int(y), int(degree)) + tail_str
    
#@bg11_40323245.route('/circle36/<int:x>/<int:y>/<int:degree>')
...
@bg11_40323245.route('/circle35/<x>/<y>/<degree>/<a>/<b>/<degree2>')
...
@bg11_40323245.route('/a')
def draw_a():
    return head_str + chain_str + a(0, 0) + tail_str
@bg11_40323245.route('/task45_1')
def task45_1():
    outstring = '''
<!DOCTYPE html>
<html>
