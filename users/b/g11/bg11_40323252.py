...
bg11_40323252 = Blueprint('bg11_40323252', __name__, url_prefix='/bg11_40323252', template_folder='templates')




@bg11_40323252.route('/task52_1')
def task52_1():
    outstring = '''
<!DOCTYPE html>
<html>
