...
bg11_40323223 = Blueprint('bg11_40323223', __name__, url_prefix='/bg11_40323223', template_folder='templates')




@bg11_40323223.route('/task23_1')
def task23_1():
    outstring = '''
<!DOCTYPE html>
<html>
