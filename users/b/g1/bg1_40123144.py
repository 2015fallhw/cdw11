...
bg1_40123144 = Blueprint('bg1_40123144', __name__, url_prefix='/bg1_40123144', template_folder='templates')




@bg1_40123144.route('/one')
def one():
    outstring = '''
<!DOCTYPE html>
<html>
