...
b40123131_cdw13 = Blueprint('b40123131_cdw13', __name__, url_prefix='/b40123131_cdw13', template_folder='templates')
...
@b40123131_cdw13.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@b40123131_cdw13.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@b40123131_cdw13.route('/circle1/<x>/<degree>', defaults={'y': 0})
@b40123131_cdw13.route('/circle1/<x>/<y>/<degree>')
#@b40123131_cdw13.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@b40123131_cdw13.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@b40123131_cdw13.route('/circle2/<x>/<degree>', defaults={'y': 0})
@b40123131_cdw13.route('/circle2/<x>/<y>/<degree>')
#@b40123131_cdw13.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@b40123131_cdw13.route('/twocircle/<x>/<y>')
@b40123131_cdw13.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@b40123131_cdw13.route('/eighteenthirty/<x>/<y>')
@b40123131_cdw13.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@b40123131_cdw13.route('/snap')
...
@b40123131_cdw13.route('/snap_link')
...
@b40123131_cdw13.route('/snap_gear')
def snap_gear():
    outstring = '''
<!DOCTYPE html>
<html>
