...
<script type="text/python" src="/ag9_40323132/a2_40323132"></script>

<!-- 以協同方式加上 40323152 的 A 程式碼 -->
<script type="text/python" src="/ag9_40323132/a3_40323132"></script>

<!-- 以協同方式加上 40323152 的 A 程式碼 -->
<script type="text/python" src="/ag9_40323132/a4_40323132"></script>

<!-- 以協同方式加上 40323152 的 A 程式碼 -->
<script type="text/python" src="/ag9_40323132/a5_40323132"></script>
</body>
</html>
'''
    return outstring
    
@ag9_40323132.route('/a2_40323132')
def task2():
    outstring = '''
from javascript import JSConstructor
from browser import window
...
@ag9_40323132.route('/a3_40323132')
def task3():
    outstring = '''
from javascript import JSConstructor
from browser import window
...
@ag9_40323132.route('/a4_40323132')
def task4():
    outstring = '''
from javascript import JSConstructor
from browser import window
...
@ag9_40323132.route('/a5_40323132')
def task5():
    outstring = '''
from javascript import JSConstructor
from browser import window
