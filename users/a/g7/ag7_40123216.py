...
ag7_40123216 = Blueprint('ag7_40123216', __name__, url_prefix='/ag7_40123216', template_folder='templates')




@ag7_40123216.route('/task4a')
def task4a():
    outstring = '''
<!DOCTYPE html>
<html>
