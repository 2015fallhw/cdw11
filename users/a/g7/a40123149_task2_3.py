...
a40123149_task2_3 = Blueprint('a40123149_task2_3', __name__, url_prefix='/ag7', template_folder='templates')

# scrum1_task1 為完整可以單獨執行的繪圖程式
@a40123149_task2_3.route('/a40123149_task2_3')
def task1():
    outstring = '''
...
# 畫 A
# 左邊兩個垂直單元
x1, y1 = mychain.basic_rot(0, 100, 90, color="green")
...
x1, y1 = mychain.basic_rot(0, -110+10+20*math.sin(80*deg)+20*math.sin(30*deg), 90, color="green")
# 上方轉 80 度
...
# 下半部, 從起點開始 -80 度
x5, y5 = mychain.basic_rot(0, -110+10+20*math.sin(80*deg)+20*math.sin(30*deg), -80, color="green")
# 下斜 -30 度
x6, y6 = mychain.basic_rot(x5, y5, -30, color="green")
# 下方水平單元
...
# 畫 D
# 左邊四個垂直單元
x1, y1 = mychain.basic_rot(0, -200, 90, color="green")
x2, y2 = mychain.basic_rot(x1, y1, 90, color="green")
x3, y3 = mychain.basic_rot(x2, y2, 90, color="green")
x4, y4 = mychain.basic_rot(x3, y3, 90, color="green")
# 上方一個水平單元
...
# 水平接回原點
mychain.basic(x10, y10, 0, -200, color="green")
