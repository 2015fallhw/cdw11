...
ag2_40323117 = Blueprint('ag2_40323117', __name__, url_prefix='/ag2_40323117', template_folder='templates')
...
@ag2_40323117.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@ag2_40323117.route('/circle36/<x>/<degree>', defaults={'y': 0})
@ag2_40323117.route('/circle36/<x>/<y>/<degree>')
