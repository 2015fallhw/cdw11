...
ag6_40323147_1 = Blueprint('ag6_40323147_1', __name__, url_prefix='/ag6_40323147_1', template_folder='templates')
...
@ag6_40323147_1.route('/eighteenthirty/<x>/<y>')
@ag6_40323147_1.route('/eighteenthirty', defaults={'x':0, 'y':0})
...
@ag6_40323147_1.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@ag6_40323147_1.route('/circle36/<x>/<degree>', defaults={'y': 0})
@ag6_40323147_1.route('/circle36/<x>/<y>/<degree>')
...
@ag6_40323147_1.route('/circle35/<x>/<y>/<degree>/<a>/<b>/<degree2>')
...
@ag6_40323147_1.route('/a')
def draw_a():
    return head_str + chain_str + a(0, 0) + tail_str
@ag6_40323147_1.route('/task50_1')
def task50_1():
    outstring = '''
<!DOCTYPE html>
<html>
...
@ag6_40323147_1.route('/threegear', defaults={'n1':15,'n2':20,'n3':18})
@ag6_40323147_1.route('/threegear/<n1>/<n2>/<n3>')
...
@ag6_40323147_1.route('/threegear2')
def threegear2():
    outstring = '''
<!DOCTYPE html>
<html>
